...
import '../../zothers/screens/relationships/relationships_screen.dart';
import '../../zothers/screens/submenus/assets_menus/menus/assets_menu_screen.dart';
import '../../zothers/screens/submenus/career_menus/menus/work_screen.dart';
...
class BadMainGameScreen extends StatefulWidget {
  final Character character;

  const BadMainGameScreen({super.key, required this.character});

  @override
  _BadMainGameScreenState createState() => _BadMainGameScreenState();
}

class _BadMainGameScreenState extends State<BadMainGameScreen> {
  ...
  void _navigateToRelationsScreen() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => const RelationshipsScreen(character: null,)),
    );
  }
